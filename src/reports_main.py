...
for number in doc_numbers:
    ...
    processing_event = soup.find("div", id=f"en{doc_numbers[cycle]}", class_="grid border") 
    ...
    with open(JSON_FILE_PATH, "r") as f:
        facility = json.load(f) # schema
        # Replace text
    
    # MARK: INTERPRET DATA
        facility : dict = replace_text(facility, "numberssss", doc_numbers[cycle])
